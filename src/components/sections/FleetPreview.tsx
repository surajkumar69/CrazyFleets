    ...
    <section className="py-24 bg-background relative">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Choose Your Ride</h2>
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground mb-6">Multiple Options Available. Check our full fleet.</p>
          <Link 
            href="/cars"
            className="inline-block px-8 py-4 border border-card-border rounded-full text-foreground font-medium hover:bg-foreground hover:text-background transition-all"
          >
            View All Cars
          </Link>
        </div>
