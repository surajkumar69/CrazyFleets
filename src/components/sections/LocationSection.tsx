...
export default function LocationSection() {
  return (
    <section className="py-24 bg-[#050813] border-y border-white/5 relative">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-6">Find Crazy Fleets</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
          ...
          <div className="w-full lg:w-1/3 glass-card p-8 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Our Office</h3>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-4">
                <Link
                  ...
                  className="flex-1 py-3 glass rounded-xl flex items-center justify-center gap-2 text-white font-medium hover:bg-white/10 transition-colors"
                >
          ...
          {/* Map Area */}
          <div className="w-full lg:w-2/3 h-[500px] rounded-3xl overflow-hidden border border-white/10 relative">
            <iframe
