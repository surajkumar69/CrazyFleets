    ...
    <div className="pt-32 pb-24 bg-[#0a0f1c] min-h-screen">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          {/* Image Side */}
          <div className="w-full lg:w-1/2 relative h-[600px] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
            <Image 
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6">
            <div className="inline-block px-4 py-1.5 bg-blue-500/10 border border-blue-500/30 rounded-full text-blue-400 font-medium text-sm w-max mb-2">
              About Us
            </div>
            ...
            <div className="mt-10">
              <Link
                href="/cars"
                className="px-8 py-4 bg-white text-black font-semibold rounded-xl inline-block hover:bg-slate-200 transition-all hover:scale-105"
              >
                View Our Fleet
              </Link>
            </div>
